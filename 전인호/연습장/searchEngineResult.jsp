								...
								<div class="sch-topChk" style="display:none">
									<ul class="sch-topChk-list">
										<li class="sch-chkList ch-chkList-on"><input
											type="checkbox" id="sectionGubun00" name="sectionGubun"
											onclick="category_checkbox();" value="ott01"
											<c:if test="${not empty ott01Chk}">checked</c:if>>
												<label>자체등급분류 </label></li>									
										<li class="sch-chkList ch-chkList-on"><input
                ...
                <c:when test="${empty searchStrChk}" >
				                    ...
				                    <li class="bTtl">통합검색</li>
										...
										<c:if
											...
											<li><a href="javascript:resultPaging('ott01');" style="color: black;">자체등급분류 (<em class="sch_category_num">${ott01.total_count + ott_report.total_count}</em>)
											</a></li>
										</c:if>
