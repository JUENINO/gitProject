...
//                System.out.println("=======================================");
            ...
            if (searchGubun.equals("All")) {
                ...
                // 사이드는 원제명만
                // 1. (조건에 맞는)원제명에 대한 건수 및 데이터 조회
                ott01_sideInformation.add(mediurlEncodingResult(walker, paramMap, request, response,
							result_ott01Url, encodeAnd, orderValue, medi_code, searchCol, "원제명"));
	...
	// 캐시 핵심로직
		private Map<String, Object> cachedSideFilter(
			    ...
			    if (filterCache.containsKey(cacheKey)) {
			        ...
			        Map<String, Object> result = mediurlEncodingResult(
